...
Route::prefix('AdminPanel')->middleware(['admin', 'auth'])->namespace('Panel')->group(function () {
    ...
    Route::get('/MakeAdmin', 'panelController@makeadmin')->name('makeAdmin');
    Route::get('/roleMaker', 'panelController@showAvalbeRole')->name('roleMaker');
    Route::post('/updateRoleForAdmin', 'panelController@userRoleUpdate')->name('userRoleUpdate');
    Route::post('/fileUpload', 'panelController@uploadPhoto')->name('uploadfile');
    Route::post('/upload-information', 'panelController@uploadInformation')->name('uploadInformation');
    Route::get('/report', 'ReportController@index')->name('report.index');
    Route::get('/change-current-plan/{id}','panelController@changePlan')->name('panel.plan');

});
Route::prefix('userPanel')->middleware(['auth'])->namespace('UserPanel')->group(function () {
...
//        return"sdfsdf";
        Artisan::call('cache:clear');Artisan::call('view:clear');
        // Auth::loginUsingId(2);
