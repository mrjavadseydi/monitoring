...
class StrategyController extends Controller {
    ...
    public function index() {
        ...
        return view('admin/strategy/index', compact('data', 'arr', 'category','program','act1','dact','percent'));
    }
    ...
    public function store(StrategyRequest $request) {
        ...
        $str->plan_id = $plan_id;
        $str->save();
        return back()->with('success', 'راهبرد با موفقیت در دیتابیس ذخیره شد !');
    }
    ...
    public function edit($id) {
        ...
        return view('admin/strategy/edit', compact('category', 'goal', 'data', 'ex'));
    }
    ...
    public function destroy($id) {
        ...
        return view('admin/index')->with('success', 'حذف راهبرد با موفقیت انجام شد !');
    }
