...
@section('top_main')
    @if (!empty($pro))
        ...
        <div class="card-body">
            ...
            <div class="row">
                <P class="col-md-6 col-sm-6">کد برنامه :
                    {{ $pro['category'] . '-' . $pro['strategy'] . '-' . $pro['row'] }}</P>
                @if ($pro['dead_line'] == 6)
                    <p>زمان پایان : در طول دوره </p>
                @else
...
@section('crump')
    ...
    <div class="content-header p-0">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">لیست اقدامات</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('panel') }}">خانه</a></li>
                        <li class="breadcrumb-item active">لیست اقدامات</li>
                    </ol>
                </div><!-- /.col -->
            </div>
        </div><!-- /.container-fluid -->
...
@section('main')
    ...
    <div class="card-header">
        <span class="card-title" style="padding-left: 2%">لیست اقدامات</span>
        @if(\Illuminate\Support\Facades\Cache::get('edit')=="1")

            @if (isset(request()->only))
                <a href="{{ route('action.create') }}?program={{ $_GET['only'] }}"
                   class="btn btn-sm btn-outline-info d-inline-block" style="height: 26px;width: 30px;"><i
                        class="fa fa-plus"></i></a>
            @else
                <a href="{{ route('action.create') }}" class="btn btn-sm btn-outline-info d-inline-block"
                    ...
                    <td>
                        @if(\Illuminate\Support\Facades\Cache::get('edit')=="1")
                            ...
                            <a class="edit" data-toggle="tooltip" data-placement="top" title="ویرایش"
                               href="{{ route('action.edit', $d['id']) }}"><i style="font-size: 20px;"
