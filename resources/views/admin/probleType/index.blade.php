...
@section('crump')
    ...
    <div class="content-header p-0">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">لیست نوع موانع</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('panel') }}">خانه</a></li>
                        <li class="breadcrumb-item active">نوع موانع</li>
                    </ol>
                </div><!-- /.col -->
            </div>
        </div><!-- /.container-fluid -->
...
@section('main')
    ...
    <div class="card-header">
        <span class="card-title" style="padding-left: 2%">لیست نوع موانع</span>
        <a href="{{route('problemType.create')}}" class="btn btn-sm btn-outline-info d-inline-block"
        ...
        $(document).on('click', '.trashbtn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{route('problemType.index')}}/"+id,
