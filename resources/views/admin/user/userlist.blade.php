...
@section('main')
    <div class="card-header">
        <span class="card-title" style="padding-left: 2%">لیست کاربران</span>
        <a href="{{route('user.create')}}" class="btn btn-sm btn-outline-info d-inline-block"
        ...
        <table id="myTable" class="table  table-hover table-striped">
            ...
            @foreach($data as $d)
                <tr>
                    ...
                    <td>{{$d['category']}}</td>
                    <td>
                        <a class="edit" data-toggle="tooltip" data-placement="top"  title="ویرایش"  href="{{route('user.edit',$d['id'])}}"><i  style="font-size: 20px" class="fa fa-edit"></i></a>
                        <a class="look" data-toggle="tooltip" data-placement="top"  title="تغییر دسترسی"  href="{{route('user.show',$d['id'])}}"><i  style="font-size: 20px" class="fa fa-users"></i></a>
