            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item ">تاییدیه</li>
...
@section('main')
    ...
    <div class="card-body">
        ...
        @endif
        <div class="p-2">
            <form action="{{route('submit.update',$data['id'])}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6  col-sm-6">
                        ...
                        <select onchange="f5()" class="js-example-basic-single form-control col-md-12  col-sm-12 select1" name="done">
                            <option @if($data['done']==0)
                                    {{'selected'}}
                                    @endif value="0">عدم تایید
                            </option>
                ...
                <br>
                <div class="col-12 text-ar" style="">
