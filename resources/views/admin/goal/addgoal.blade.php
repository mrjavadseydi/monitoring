...
@section('crump')
    ...
    <div class="content-header p-0">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">افزودن هدف</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('panel') }}">خانه</a></li>
                        <li class="breadcrumb-item active">افزودن  هدف</li>
                    </ol>
                </div><!-- /.col -->
            </div>
        </div><!-- /.container-fluid -->
        ...
        <form action="{{route('goal.store')}}" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="category" class="form-control" placeholder="نام هدف : ارتقا ...">
                </div>
                <div class="col-6">
